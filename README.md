...
| Windows | Linux |
| ---- | ---- |
| [v1.9.31](https://github.com/Pyrdacor/freeserf.net/releases/download/v1.9.31/Freeserf.net-Windows.zip "Windows v1.9.31") | [v1.9.31](https://github.com/Pyrdacor/freeserf.net/releases/download/1.9.31/Freeserf.net-Linux.tar.gz "Linux v1.9.31") |
