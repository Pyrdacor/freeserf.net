...
| Windows | Linux |
| ---- | ---- |
| [v2.0.3](https://github.com/Pyrdacor/freeserf.net/releases/download/v2.0.3/Freeserf.net-Windows.zip "Windows v2.0.3") | [v2.0.3](https://github.com/Pyrdacor/freeserf.net/releases/download/v2.0.3/Freeserf.net-Linux.tar.gz "Linux v2.0.3") |
