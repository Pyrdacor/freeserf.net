...
| Windows | Linux |
| ---- | ---- |
| [v2.1.1](https://github.com/Pyrdacor/freeserf.net/releases/download/v2.1.1/Freeserf.net-Windows.zip "Windows v2.1.1") | [v2.1.0](https://github.com/Pyrdacor/freeserf.net/releases/download/v2.1.1/Freeserf.net-Linux.tar.gz "Linux v2.1.1") |
