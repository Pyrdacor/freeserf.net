...
| Windows | Linux |
| ---- | ---- |
| [v2.0.0-pre](https://github.com/Pyrdacor/freeserf.net/releases/download/v2.0.0-pre2/Freeserf.net-Windows.zip "Windows v2.0.0 Pre-Release") | [v2.0.0-pre](https://github.com/Pyrdacor/freeserf.net/releases/download/v2.0.0-pre2/Freeserf.net-Linux.tar.gz "Linux v2.0.0 Pre-Release") |
