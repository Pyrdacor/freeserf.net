...
namespace FreeserfAndroid
{
    ...
    {
        private static ViewOptions DefaultOptions = GetDefault();

        private static ViewOptions GetDefault()
        {
        ...
        public readonly IView window = null;
        IMouse mouse = null;

        public Window() : this(DefaultOptions)
        {

        }
  
        public Window(ViewOptions options)
        {
        ...
        public Rectangle<int> ClientRectangle => new(0, 0, 0, 0);
